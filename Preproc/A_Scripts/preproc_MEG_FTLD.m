...
% dataset to study syndromes of frontotemporal lobar degeneration
%
% This script contains preprocessing scripts for reproducing MEG 
% data paper results
...
% Adapted by Alistair Perry


%% Define Paths and variables

% Assumed you are calling as argument the directory that includes BioFIND data,
...
parfor sub = 1:nsub
    ...
    %in biofind1
    S.channels = {'EOG', 'EEG', 'MEGMAG', 'MEGPLANAR'}; % + EEG, -ECG
    S.checkboundary = 0;
...
parfor sub = 1:nsub
    ...
    %Add extra filtering steps
    infile = fullfile(processed_pth,sprintf('sub-Sub%04d',sub),'ffffdspmeeg');
